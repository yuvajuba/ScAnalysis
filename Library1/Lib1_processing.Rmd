...
## Directories :
if(params$c3m == T){
  out_object_dir <- "~/Bureau/Juba/Projects/SingleCell/Library1/Out_objects/"
  out_figure_dir <- "~/Bureau/Juba/Projects/SingleCell/Library1/Out_figures/"
  out_seurat_dir <- "~/Bureau/Juba/Projects/SingleCell/Library1/SeuratObjects/"
} else {
...
```{r}
if(params$c3m == T){
  SeuratObj <- readRDS("~/Bureau/Juba/Projects/SingleCell/Library1/SeuratObjects/Seurat2.rds")
} else {
