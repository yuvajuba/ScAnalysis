...
## Directories :
if(params$c3m == T){
  out_object_dir <- "~/Bureau/Projects/SingleCell/ScAnalysis/Library2/Out_objects/"
  out_figure_dir <- "~/Bureau/Projects/SingleCell/ScAnalysis/Library2/Out_figures/"
  out_seurat_dir <- "~/Bureau/Projects/SingleCell/ScAnalysis/Library2/SeuratObjects/"
} else {
...
```{r}
if(params$c3m == T){
  SeuratObj <- readRDS("~/Bureau/Projects/SingleCell/ScAnalysis/Library2/SeuratObjects/Seurat2.rds")
} else {
...
[We'll realize the inspection using the expression plot and violin plots with the 0.3 resolution below]{style='color:purple ; font-weight:600 ; font-size:100%'}
...
SeuratObj_filt@meta.data <- SeuratObj_filt@meta.data %>% 
  mutate(MyClusters = case_when(Clust_res0.3 %in% c("0D","2D","5D") ~ "Diag",
                                Clust_res0.3 %in% c("0R","2R","5R") ~ "Rel_in_Diag",
                                Clust_res0.3 %in% c("1R","3R","6R") ~ "Rel",
                                Clust_res0.3 %in% c("1D","3D","6D") ~ "Diag_in_Rel"))
