...
[Over Representative Analysis (ORA)]{style='font-size:22; color:gold; margin-bottom:30px; font-weight:600'}

<p class='p3'>UpGenes</p>

```{r}
Markers1_lib1$lib1_allR_vs_allD$Up
```
...
<p class='p3'>DownGenes</p>

```{r}
Markers1_lib1$lib1_allR_vs_allD$Down
```
...
[Gene Set Enrichment Analysis (GSEA)]{style='font-size:22; color:gold; margin-bottom:30px; font-weight:600; margin-top:80'}
...
```{r}
Markers1_lib1$lib1_allR_vs_D$Up
```
...
```{r}
Markers1_lib1$lib1_allR_vs_D$Down
```
...
```{r}
Markers1_lib1$lib1_IC_vs_D$Down
```
...
```{r}
Markers1_lib1$lib1_allR_vs_IC$Up
```
...
```{r}
Markers1_lib1$lib1_allR_vs_IC$Down
```
...
```{r}
Markers1_lib1$lib1_Rcl1_vs_Dcl1$Down
```
...
```{r}
Markers1_lib1$lib1_Rcl1_vs_ICcl1$Down
```
...
```{r}
Markers1_lib1$lib1_ICcl1_vs_Dcl1$Down
```
...
-   We have 106 genes in common with those up regulated from IC to R.

```{r}
Common_markers$`R-D vs R-IC vs IC-D UP`$intersections$`R-D ∩ R-IC`
```
...
-   We have 78 genes in common with those down regulated from D to IC.

```{r}
Common_markers$`R-D vs R-IC vs IC-D Down`$intersections$`R-D ∩ IC-D`
```

-   We have 118 genes in common with those down regulated from IC to R 

```{r}
Common_markers$`R-D vs R-IC vs IC-D Down`$intersections$`R-D ∩ R-IC`
```
...
```{r}
Common_markers$`Rcl1-Dcl1 vs Rcl1-ICcl1 vs ICcl1-Dcl1 Down`$intersections$`Rcl1-Dcl1 ∩ ICcl1-Dcl1`
```

-   We have 61 genes in common with those down regulated from IC to R.

```{r}
Common_markers$`Rcl1-Dcl1 vs Rcl1-ICcl1 vs ICcl1-Dcl1 Down`$intersections$`Rcl1-Dcl1 ∩ Rcl1-ICcl1`
```
