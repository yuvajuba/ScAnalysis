...
<p class='important'>We will inspect the genes inside library1, comparing the clonotypes etc...</p>
...
treeplot(xx, 
         ...
         hilight = F,
         fontsize = 3,
         offset.params = list(bar_tree = rel(2), tiplab = rel(2.5), hexpand = 0.05, extend = 0.25),
         cluster.params = list(n= 6,
                               method = "ward.D",
                               color = NULL,
                               label_words_n = 3,
                               label_format = 5),
         clusterPanel.params = list(clusterPanel = "pie",
                                    pie = "count",
                                    legend_n = 3,
                                    colnames_angle = 90))+
